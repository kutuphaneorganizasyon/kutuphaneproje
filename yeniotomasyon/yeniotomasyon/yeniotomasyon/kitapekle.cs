...
namespace yeniotomasyon
{
    public partial class kitapekle : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            baglan.Open();
            if (textBox11.Text.Trim() != "" && textBox1.Text.Trim() != "" && textBox2.Text.Trim() != "" && textBox3.Text.Trim() != "" && textBox4.Text.Trim() != "" && textBox5.Text.Trim() != "" && textBox12.Text.Trim() != "" && textBox6.Text.Trim() != "" && textBox7.Text.Trim() != "" && textBox8.Text.Trim() != "" && textBox9.Text.Trim() != "" && textBox10.Text.Trim() != "" && textBox10.Text.Trim() != "" && textBox13.Text.Trim() != "" && textBox14.Text.Trim() != "" && textBox15.Text.Trim() != "" && textBox16.Text.Trim() != "" && textBox17.Text.Trim() != "" && textBox18.Text.Trim() != "" && textBox19.Text.Trim() !="" && textBox20.Text.Trim() !="" )  
            {
                string komut = "INSERT INTO  kitap (kitap_id, kitap_adi, baski, cilt, isbn, kitap_dili, cevirme_yili,sayfa_sayisi, raf_konumu, adet, yayin_yili, yazar_id, yazar_ad, cevirmen_id, yazar_soyad, cevirmen_ad, cevirmen_soyad, yayinevi_ad, kategori_id ,yayinevi_id,) values (" + textBox11.Text + " , " + textBox1.Text + " , " + textBox2.Text + " ," + textBox3.Text + " ," + textBox4.Text + " ," + textBox5.Text + " ," + textBox12.Text + " ," + textBox6.Text + " ," + textBox7.Text + " ," + textBox8.Text + " ," + textBox9.Text + " ," + textBox10.Text + " ," + textBox13.Text + " ," + textBox14.Text + " ," + textBox15.Text + " ," + textBox16.Text + " ," + textBox17.Text + " ," + textBox18.Text + " ," + textBox19.Text + " ," + textBox20.Text + " ," + ")";
